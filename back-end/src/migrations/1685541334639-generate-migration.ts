...
export class generateMigration1685541334639 implements MigrationInterface {
    name = 'generateMigration1685541334639'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "FK_a4cbd9aa8f88cc16dfe5b07661e" FOREIGN KEY ("additionalDataId") REFERENCES "additional-data"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
