...
export class generateMigration1685027101003 implements MigrationInterface {
  ...
  public async up( queryRunner: QueryRunner ): Promise<void> {
    await queryRunner.query(
      'CREATE TABLE "additional-data" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "email" character varying NOT NULL, "telephone" integer NOT NULL, CONSTRAINT "PK_900be121372a4a74ac96140caa5" PRIMARY KEY ("id"))'
    );
    await queryRunner.query(
      'CREATE TABLE "contacts" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "contact_userId" character varying NOT NULL, "userId" uuid, CONSTRAINT "UQ_efdbddacdfa561c3347599c191f" UNIQUE ("contact_userId"), CONSTRAINT "PK_b99cd40cfd66a99f1571f4f72e6" PRIMARY KEY ("id"))'
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'ALTER TABLE "users" ADD CONSTRAINT "FK_a4cbd9aa8f88cc16dfe5b07661e" FOREIGN KEY ("additionalDataId") REFERENCES "additional-data"("id") ON DELETE NO ACTION ON UPDATE NO ACTION'
    );
  }

  public async down( queryRunner: QueryRunner ): Promise<void> {
    await queryRunner.query(
      'ALTER TABLE "users" DROP CONSTRAINT "FK_a4cbd9aa8f88cc16dfe5b07661e"'
    );
    await queryRunner.query(
